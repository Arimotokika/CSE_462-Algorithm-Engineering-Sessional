...
\node[draw, rounded corners, fill=blue!20, text width=3.5cm, align=center] (result) at (0, -3) {\textbf{Hybrid GA}\\36--54\% better\\on large instances};
...
\vspace{-0.2cm}
{\footnotesize \textbf{Key finding:} Hybrid GA improvement over standard GA grows dramatically with problem size -- from $\sim$1\% (small) to $\sim$54\% (large).}
\end{frame}

\begin{frame}{Key Findings}
\begin{block}{MMR-IR vs MMR (Original)}
\begin{itemize}
    \item \textbf{Consistent improvement:} 0.2--4.8\% across all tiers and scenarios
...
\begin{itemize}
    \item \textbf{Small:} 1--16\% improvement (modest)
    \item \textbf{Medium:} 10--45\% improvement (significant)
    \item \textbf{Large:} \textbf{36--54\% improvement} (dramatic)
...
\midrule
small\_balanced & 174 & 170 & 171 & 171 \\
small\_scarce & 475 & 471 & 468 & 469 \\
small\_rich & 74.5 & 72.2 & 87.8 & 73.8 \\
\midrule
medium\_balanced & 645 & 642 & 1012 & 645 \\
medium\_scarce & 2085 & 2079 & 2318 & 2083 \\
medium\_rich & 244 & 243 & 443 & 243 \\
\midrule
large\_balanced & 1475 & 1473 & 2740 & 1474 \\
large\_scarce & 5169 & 5164 & 6033 & 5169 \\
large\_rich & 549 & 549 & 1188 & 549 \\
\bottomrule
\end{tabular}
\end{table}
